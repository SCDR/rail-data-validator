// validator.ts
import { ValidationRule, ValidationError, DataRow } from './types';
...
export class DataValidator {
     ...
     */
    addRowRule(rule: ValidationRule): void { // 定义一个添加行规则的方法，接收一个ValidationRule类型的参数，没有返回值
    ...
    getErrorStatistics(): {
        ...
        const stats = {
            byColumn: {} as Record<string, { count: number; errors: ValidationError[] }>,
            byRule: {} as Record<string, { count: number; errors: ValidationError[] }>,
